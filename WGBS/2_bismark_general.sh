...
#rename "s/_R1_bismark_bt2/_bismark_bt2/g" ${outdir}/${sample}_R1_bismark_bt2_*
...
bismark_methylation_extractor --paired-end --bedgraph --no_overlap --comprehensive --merge_non_CpG --report \
